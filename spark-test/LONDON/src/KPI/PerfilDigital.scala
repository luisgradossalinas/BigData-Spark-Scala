...
object PerfilDigital {
  ...
  /**
   * Devuelve la cantidad de transacciones que existen por cada tipo de Perfil Tecnológico
  ...
  /**
   * Devuelve la suma de montos de las transacciones que existen por cada tipo de Perfil Tecnológico por meses
   */
