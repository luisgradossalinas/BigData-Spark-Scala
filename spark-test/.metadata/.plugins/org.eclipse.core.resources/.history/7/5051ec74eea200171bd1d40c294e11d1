...
*/
  ...
  def main(args: Array[String]) {
    ...
    kpi_clientes_recurrentes("tablon.tsv", List("100070934"), "201512", List(1, 3, 6, 12, 24)).foreach(println)
    //kpi_clientes_recurrentes("tablon.tsv", List("100070905"), "201512", Array(1, 3, 6, 12, 24))
